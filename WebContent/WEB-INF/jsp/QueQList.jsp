...
<div class="x-body">
    ...
    <xblock>
        ...
        onclick="location.href='<%=basePath%>findRecordAdd'"
    ...
    <table class="layui-table">
        ...
        <tr>
            ...
            <td>${re.remark }</td>
            <td class="td-manage">
                <a title="编辑" href="<%=basePath%>findRecordById/${re.id}">
                    <i class="layui-icon">&#xe642;</i>
                </a>
                <a title="删除" href="<%=basePath%>deleteRecord/${re.id}"  
