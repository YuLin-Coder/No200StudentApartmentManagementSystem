...
<div class="x-body">
    <form class="layui-form layui-form-pane" action="<%=basePath %>doUpdatePwd" id="add">
            ...
            <div class="layui-tab-content" >
                <div class="layui-tab-item layui-show">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="oldpassword"  autocomplete="off" placeholder=""
                                   class="layui-input" >
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="password" name="passWord" value="" autocomplete="off" placeholder="新密码为空则不修改"
                                   class="layui-input">
                        </div>
                    </div>
