...
<div class="x-body">
    <form class="layui-form layui-form-pane" action="<%=basePath %>insertAdmin" method="post">
                ...
                <div class="layui-tab-item layui-show">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="name" autocomplete="off" placeholder="姓名"
                    ...
                    <div class="layui-form-item">
                        <label class="layui-form-label">  <span class='x-red'>*</span>电话
                        </label>
                        <div class="layui-input-block">
                    ...
                    <div class="layui-form-item">
                        <label class="layui-form-label">  <span class='x-red'>*</span>账号
                        </label>
                        <div class="layui-input-block">
                            <input type="text" name="stu_code" autocomplete="off" placeholder="账号"
                                   class="layui-input" lay-verify="required" value="">
                        </div>
                    </div>
                    <div class="layui-form-item">
                  ...
                  <div class="layui-form-item">
                        <label class="layui-form-label">  <span class='x-red'>*</span>宿舍楼
                        </label>
                        <div class="layui-input-block">
                            <input type="text" name="dormBuildId" autocomplete="off" placeholder="管理的宿舍楼"
                                   class="layui-input" lay-verify="required" value="">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="role_id" autocomplete="off" placeholder="默认为1"
                                   class="layui-input" lay-verify="required" value="1">
                        </div>
                    </div>
                    <div class="layui-form-item">
